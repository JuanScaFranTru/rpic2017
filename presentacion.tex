...
\begin{frame}{Epidemiología panorámica}
  ...
  \begin{center}
    \textbf{Epidemiología satelital} %% TODO
  \end{center}
...
\begin{frame}{Dengue, Zika y Chikungunya}
  ...
  \begin{itemize}
  \item Enfermedades transmitidas por vectores %% TODO
...
\begin{frame}{Aprendizaje Automático (ML)}
  ...
  Definicion de que las maquinas que aprenden %% TODO
